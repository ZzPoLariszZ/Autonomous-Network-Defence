...
class RandomAgent(BaseAgent):
    ...
    def get_action(self, observation, action_space):
        ...
        # start by scanning randomly
        random_subnet = action_space["subnet"]
        shuffle(list(random_subnet))
        for subnet in random_subnet:
        ...
        # discover network services randomly
        # act on ip addresses discovered in first subnet
        random_addresses = [i for i in action_space["ip_address"]]
        ...
        # priv esc on owned hosts randomly
        random_hostnames = action_space['hostname']
        shuffle(list(random_hostnames))
        for hostname in random_hostnames:
        ...
        # access unexploited hosts randomly
        for address in random_addresses:
